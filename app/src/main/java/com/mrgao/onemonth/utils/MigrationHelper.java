...
public final class MigrationHelper {
    ...
    private static void migrate(SQLiteDatabase db, Class<? extends AbstractDao<?, ?>>... daoClasses) {
    ...
    static void migrate(Database database, ReCreateAllTableListener listener, Class<? extends AbstractDao<?, ?>>... daoClasses) {
        weakListener = new WeakReference<>(listener);
        migrate(database, daoClasses);
    }

    private static void migrate(Database database, Class<? extends AbstractDao<?, ?>>... daoClasses) {
