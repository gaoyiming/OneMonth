 ...
 * <pre>
 *    Today_Task_Fragment.newInstance(30).show(supportFragmentManager, "dialog")
 * </pre>
 *
 * You activity (or fragment) needs to implement [Today_Task_Fragment.Listener].
 */
class Today_Task_Fragment : BottomSheetDialogFragment() {
    ...
    companion object {
        ...
        fun newInstance(itemCount: Int): Today_Task_Fragment =
                Today_Task_Fragment().apply {
