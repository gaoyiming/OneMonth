...
import com.mrgao.onemonth.bean.Ocr;
import com.mrgao.onemonth.service.RecognizeService;
...
public class OcrActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCopy.setOnClickListener(v -> {
            clip.setText(editer.getText().toString());
...
//        });
    ...
    private void initAccessTokenWithAkSk() {
        OCR.getInstance(this).initAccessTokenWithAkSk(new OnResultListener<AccessToken>() {
            ...
            public void onResult(AccessToken result) {
                ...
                hasGotToken = true;
                RecognizeService.recAccurateBasic(OcrActivity.this, images.get(0).getCompressPath(),
                        text -> infoPopText(text)
                );
            }
        ...
        }, getApplicationContext(), "HWs2nvqcXtORQFK4mrxlZrFX", "dbAYzi7ls6ypt8ncef6DqEKtu6NGxZnc");
    }
    ...
    private void infoPopText(final String result) {
        ...
        Ocr ocr = new Gson().fromJson(result, Ocr.class);
        List<Ocr.WordsResultBean> wordsResult = ocr.getWords_result();
        if (wordsResult != null && wordsResult.size() > 0) {
            for (Ocr.WordsResultBean wordBean : wordsResult) {
                textResult.append(wordBean.getWords());
            }
        }
        editer.setText(textResult.toString());
