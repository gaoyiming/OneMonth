...
/** 
 * DAO for table "JUDGE_BY_DAY".
*/
public class JudgeByDayDao extends AbstractDao<JudgeByDay, Long> {

    public static final String TABLENAME = "JUDGE_BY_DAY";

    /**
     * Properties of entity JudgeByDay.<br/>
    ...
    public JudgeByDayDao(DaoConfig config) {
        super(config);
    }
    
    public JudgeByDayDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"JUDGE_BY_DAY\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"JUDGE_BY_DAY\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, JudgeByDay entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, JudgeByDay entity) {
        stmt.clearBindings();
    ...
    @Override
    public JudgeByDay readEntity(Cursor cursor, int offset) {
        JudgeByDay entity = new JudgeByDay( //
    ...
    @Override
    public void readEntity(Cursor cursor, JudgeByDay entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(JudgeByDay entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(JudgeByDay entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(JudgeByDay entity) {
